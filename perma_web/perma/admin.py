...
class RegistrarAdmin(SimpleHistoryAdmin):
    ...
    list_display = ['name', 'status', 'email', 'type', 'international', 'website', 'address', 'registrar_users', 'last_active', 'orgs_count', 'link_count', 'tag_list', 'orgs_private_by_default', 'unlimited', 'nonpaying', 'cached_subscription_status', 'cached_subscription_started', 'cached_subscription_rate', 'base_rate', 'local_subscription_description']
    ...
    fieldsets = (
        ...
        ("Tier", {'fields': ('nonpaying', 'base_rate', 'local_subscription_description', 'cached_subscription_started', 'cached_subscription_status', 'cached_subscription_rate', 'unlimited', 'link_limit', 'link_limit_period', 'bonus_links')}),
    )
    inlines = [
...
class LinkAdmin(SimpleHistoryAdmin):
    ...
    inlines = [
        ...
        new_class("CaptureJobInline", admin.StackedInline, model=CaptureJob,
                   fields=['status', 'superseded', 'message', 'archive_formats', 'step_count', 'step_description', 'human'],
                   readonly_fields=['message', 'archive_formats', 'step_count', 'step_description', 'human'],
                   can_delete=False),
        IAFileInline
    ]
...
class CaptureJobAdmin(admin.ModelAdmin):
    list_display = ['id', 'creation_timestamp', 'status', 'superseded', 'message', 'validation_status_code', 'archive_formats', 'created_by_id', 'link_id', 'human', 'submitted_url', 'scoop_state', 'scoop_job_id', 'engine']
    ...
    readonly_fields = ['creation_timestamp', 'validation_status_code']
